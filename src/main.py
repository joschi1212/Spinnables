...
class WindowApp:
    ...
    def __init__(self):
        ...
        self.l = 0.15 # side length of single voxel - border and inner voxel always the same.
        self.density = 1
        self.fillings = None
...
################################################################################
    ...
    def draw_voxels(self, cells, l, colr, voxels_name):
        ...
        for center in cells:
            ...
            cell_matr = [[v0, v1], [v0, v2], [v0, v4], [v1, v3], [v1, v5], [v2, v3], [v2, v6], [v3, v7], [v4, v5],
                         [v4, v6], [v5, v7], [v6, v7]]
    ...
    def _on_load_voxel_done(self, save_path):
        ...
        try:
            ...
            if (os.path.exists(save_file)):
                ...
                print("border_voxel side length loaded: " + str(self.l))
            else:
...
#####################################################################################################
    def _on_save_voxel(self):
        self.save_voxel_data(self.inner_voxels, self.l, self.border_voxels, self.l, self.model_name)
    ...
    def _on_optimize_mass(self):
        ...
        try:
            ...
            if (want_mystic == 'y'):
                ...
                print("Mystic Optimization skipped")
...
############################################################################################
    ...
    def setup_gui(self, w):
        ...
        grid_button = gui.Button("Construct Inner and Outer Grid")
        ...
        bgrid_button = gui.Button("Show Border Grid")
